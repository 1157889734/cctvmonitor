...
QT_MOC_LITERAL(1, 9, 17), // "sliderPressSianal"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 8), // "iPosTime"
QT_MOC_LITERAL(4, 37, 16) // "sliderMoveSianal"

    },
    "mySlider\0sliderPressSianal\0\0iPosTime\0"
    "sliderMoveSianal"
};
...
void mySlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sliderPressSianal((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->sliderMoveSianal((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (mySlider::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mySlider::sliderPressSianal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (mySlider::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mySlider::sliderMoveSianal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void mySlider::sliderPressSianal(int _t1)
{
...
// SIGNAL 1
void mySlider::sliderMoveSianal(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
