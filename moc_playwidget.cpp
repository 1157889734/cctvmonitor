...
QT_MOC_LITERAL(1, 11, 15), // "sendClickSignal"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 6) // "sender"

    },
    "playwidget\0sendClickSignal\0\0sender"
};
...
void playwidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendClickSignal((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (playwidget::*)(QObject * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&playwidget::sendClickSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void playwidget::sendClickSignal(QObject * _t1)
{
